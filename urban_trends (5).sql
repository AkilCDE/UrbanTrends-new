...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2025 at 02:54 AM
...
--
ALTER TABLE `delivery_schedules`
  ADD CONSTRAINT `delivery_schedules_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `order_promotions`
  ...
  ADD CONSTRAINT `order_promotions_ibfk_2` FOREIGN KEY (`promotion_id`) REFERENCES `promotions` (`id`) ON DELETE CASCADE;
